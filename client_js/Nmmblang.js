...
var l_msg_Max_Lon={cat: "Longitud màxima", spa: "Longitud máxima", eng: "Maximum longitude"};
  ...
  document.getElementById("reportAspect-feedback-problem-label").innerHTML=DonaCadenaJSON(GUF_ReportAspectCode["problem"]);	
	...
	document.getElementById("email-individual-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "Correu electrónic de l'individu", spa: "Correo electrónico del individuo", eng: "Individual email"});
	...
	document.getElementById("account-subtitle-text").innerHTML=DonaCadenaJSON({cat: "Canvia les característiques bàsiques del teu compte i la configuració d'idioma", spa: "Cambie las características bàsicas de su cuenta y la configuración de idioma", eng: "Change your basic account and language settings."});
	...
	document.getElementById("language_screen_descrip").innerHTML=DonaCadenaJSON({cat: "L'idioma que fas servir (l'entorn canviarà a aquest idioma).", spa: "El idioma que usas (el entorno cambiarà a este idioma).", eng: "The language you use (the interface will change to this language)."});
