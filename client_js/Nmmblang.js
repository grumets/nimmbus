...
var Msg_Geolocation_not_supported={cat: "La geolocalització des del dispositiu no està suportada en aquest navegador d'Internet", spa: "La geolocalización desde el dispositivo no está soportada en este navegador de Internet", eng: "Geolocation is not supported by this Internet browser"};
...
var l_msg_Define_Scope_LP={cat: "Introdueix l'àmbit/s referent a aquest registre", spa: "Introduce el ámbito/s referente a este registro", eng: "Define this log's scope/s"};
	...
	document.getElementById("idFeature-logpage-resource_screen").innerHTML=DonaCadenaJSON({cat: "Identificador de l'objecte:", spa: "Identificador del objeto:", eng: "Feature identifier:"});
	...
	document.getElementById("logpage-link-resource_screen").innerHTML=DonaCadenaJSON({cat: "URL amb informaci� adicional", spa: "URL con informaci� adicional", eng: "URL with additional information"});			
	document.getElementById("idFeature-logpage-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "per exemple: 0001", spa: "por ejemplo: 0001", eng: "for example: 0001"});
	document.getElementById("title-logpage-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "per exemple: instal�laci� de nous sensors a la parcel�la d'estudi", spa: "por ejemplo: instalaci�n de nouevos sensores en la parcela de estudio", eng: "for example: installation of new sensors on the study plot"});
	document.getElementById("ini-content-date-time-logpage-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "inici del per�ode temporal sobre el qual aplica el contingut del registre", spa: "inicio del periodo temporal sobre el cual aplica el contenido del registro", eng: "begining of the time period over which the contents of the log apply"});
	document.getElementById("fin-content-date-time-logpage-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "final del per�ode temporal sobre el qual aplica el contingut del registre", spa: "final del periodo temporal sobre el cual aplica el contenido del registro", eng: "ending of the time period over which the contents of the log apply"});
  ...
  document.getElementById("reportAspect-feedback-problem-label").innerHTML=DonaCadenaJSON(GUF_ReportAspectCode["problem"]);	
	...
	document.getElementById("reprodUsage-code-resource_screen").innerHTML=DonaCadenaJSON({cat: "Fragment de codi o sentència d'execució (text)", spa: "Fragmento de código o sentencia de ejecución (texto)", eng: "Code snippet or execution sentence (text)"});	
	document.getElementById("reprodUsage-code-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "Fragment de codi o sentència d'execució necessari per a reproduir aquest ús*", spa: "Fragment de código o sentencia de ejecución necesario para reproducir este uso*", eng: "Necessary code snippet or execution sentence to reproduce this usage*"});	
	...
	document.getElementById("reprodUsage-suggApp-resource_screen_descrip").innerHTML=DonaCadenaJSON({cat: "Aplicació suggerida concreta per a obrir el codi i sentència d'execució d'aquest ús", spa: "Aplicación sugerida concreta para abrir el código o sentencia de ejecución de este uso", eng: "Specific suggested application to open the code or execution sentence of this usage"});	
