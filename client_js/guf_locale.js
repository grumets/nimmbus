...
var QCM_PublicationCategoryCode={"undefined": Msg_Indefinit,
		...
		"magazineNewspaper": {cat: "Revista o diari", spa: "Revista o periídico", eng: "Magazine or Newspaper", fre: "Magazine ou journal"},
		"atlasMap": {cat: "Atles o mapa (imprés o digital)", spa: "Atlas o mapa (impreso o digital)", eng: "Atlas or map (printed or digital)", fre: "Atlas ou carte (imprimé ou numérique)"},
		...
		"webSite": {cat: "Pàgina web completa", spa: "Pàgina web completa", eng: "Complete web site", fre: "Site web complet"},
		"webPage": {cat: "Pàgina web", spa: "Pàgina web", eng: "Web page", fre: "page Web"},
		"videoAudio": {cat: "Vídeo o audio", spa: "Vídeo o audio", eng: "Video or audio", fre: "Vidéo ou audio"},
