...
var QCM_PublicationCategoryCode={"undefined": Msg_Indefinit,
		"bookChapter": {cat: "Capítol de llibre", spa: "Capítulo de libro", eng: "Book chapter"},
		"book": {cat: "Llibre", spa: "Libro", eng: "Book"},
		"report": {cat: "Informe", spa: "Informe", eng: "Report"},
		"journalArticle": {cat: "Article de revista", spa: "Artículo de revista", eng: "Journal article"},
		"magazineNewspaper": {cat: "Revista o diari", spa: "Revista o periódico", eng: "Magazine or Newspaper"},
		"atlasMap": {cat: "Atles o mapa (imprès o digital)", spa: "Atlas o mapa (impreso o digital)", eng: "Atlas or map (printed or digital)"},
		...
		"cdDvdBlueRay": {cat: "Paquet de dades multimèdia (suport físic o a Internet)", spa: "Paquete de datos multimedia (soporte físico o en Internet)", eng: "Multimedia package (physical support or Internet)"},
		...
		"webSite": {cat: "Pàgina web completa", spa: "Página web completa", eng: "Complete web site"},
		"webPage": {cat: "Pàgina web", spa: "Página web", eng: "Web page"},
		"videoAudio": {cat: "Vídeo o àudio", spa: "Vídeo o audio", eng: "Video or audio"},
...
var CI_OnLineFunctionCode={"undefined": Msg_Indefinit,
		"download": {cat: "Descàrrega", spa: "Descarga", eng: "Download"},
		"information": {cat: "Informació", spa: "Información", eng: "Information"},
		"offlineAccess": {cat: "Accés fora de línia", spa: "Acceso fuera de línea", eng: "Offline access"},
		"order": {cat: "Comandes", spa: "Encargos", eng: "Order"},
		"search": {cat: "Cerca", spa: "Búsqueda", eng: "Search"},
		"completeMetadata": {cat: "Metadades completes", spa: "Metadatos completos", eng: "Complete Metadata"},
		"browseGraphic": {cat: "Exploració", spa: "Exploración", eng: "View"},
		"upload": {cat: "Càrrega", spa: "Carga", eng: "Upload"},
		"emailService": {cat: "Servei de correu electrònic", spa: "Servicio de correo electrónico", eng: "Email service"},
		"browsing": {cat: "Navegació", spa: "Navegación", eng: "Browsing"},
		"fileAccess":{cat: "Accés a fitxer", spa: "Acceso a fichero", eng: "File access"}};	
